    ...
    <div class="flex h-screen">
        ...
        <aside class="flex flex-col w-64 text-white bg-blue-900">
            ...
            <nav class="flex-1 p-4 space-y-2 text-base">
                ...
                <a href="#" class="block px-4 py-2 mt-4 text-center transition-all duration-200 bg-red-700 rounded-lg hover:bg-red-600">Logout</a>
            </nav>
        </aside>
        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <header class="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200">
                ...
                <div class="flex items-center space-x-4">
                    <span class="text-gray-800">Welcome, {{ session('full_name') }}</span>
                 ...
                 <section id="registration-form" class="hidden">
                    ...
                    <form class="w-full max-w-md p-6 mx-auto space-y-4 transition-transform duration-300 bg-white rounded-lg shadow-lg hover:scale-105" method="POST" action="/register_member">
                        ...
                        <div>
                            ...
                            <input type="text" id="role" name="role" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500">
                            @error('role')
                                <span class="text-sm text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
