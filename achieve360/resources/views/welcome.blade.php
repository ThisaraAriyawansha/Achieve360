...
<body class="text-gray-800 bg-gray-100">
    ...
    <section id="home" class="relative flex flex-col items-center justify-center h-screen text-white">
        ...
        <!-- Gradient Overlay -->
        <div class="absolute inset-0 bg-transparent to-indigo-700 opacity-70"></div>
        <!-- Content -->
        <div class="relative z-10 flex flex-col items-center p-6 mx-6 -mt-20 bg-black bg-opacity-0 rounded-md sm:mx-12 lg:mx-20">
